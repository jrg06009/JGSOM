    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <StandingsTable standings={{ AL: standings.AL }} teams={teams} useFullName={false} hideLeagueHeaders={true} />
        </div>
        <div>
          <h3 className="text-xl font-semibold mb-2">National League</h3>
          <StandingsTable standings={{ NL: standings.NL }} teams={teams} useFullName={false} hideLeagueHeaders={true} />
        </div>
      </div>
